...
Config.Position         = "CUSTOM-BOTTOM-POSITION"  -- Overridden by the `position` param
...
Config.Pictures = {
    ...
    CHAR_POLICE                 = "Char_police.jpg",
    CHAR_FRV                 = "Char_frv.jpg",
    CHAR_EMS                 = "Char_ems.jpg",
    CHAR_POLICERED                 = "Char_policered.jpg",
    CHAR_POLICEGREEN                = "Char_policegreen.jpg",
    CHAR_POLICEBLUE                 = "Char_policeblue.jpg",
    CHAR_POLICEYELLOW                 = "Char_policeyellow.jpg",
    CHAR_VICROADS                 = "Char_vicroads.jpg",
    CHAR_VICGOV                 = "Char_vicgov.jpg",
    CHAR_RACV                 = "Char_racv.jpg",
    CHAR_ASTRO                 = "Char_astro.jpg",
    CHAR_COURTS                 = "Char_courts.jpg"
}